 ...
 * `TRC20` functions.
 */
contract TronAlpha is TRC20, TRC20Detailed {
    ...
    constructor (uint256 price) public TRC20Detailed("YourTokenName", "YTN", 6 ) {
        _price = price;
        _mint(msg.sender, 10000000000 * (10 ** uint256(decimals()))  ); 
        
    }
    
    function becomeMember()public payable returns(uint256){
        require(msg.value >= _price ,"TRC20: Insufficient Funds Transferred");
        membership[msg.sender]=true;
        
        
    }
    function isMember() public view returns(bool){
        return membership[msg.sender]==true;
    }
